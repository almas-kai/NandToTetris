...
internal static class CompilerRegex
{
	...
	private static readonly Regex _positiveIntegerConstantRegex = new Regex(@"\b\d+\b", RegexOptions.Compiled);
	...
	{
		return _positiveIntegerConstantRegex.Match(instruction);
	}
